 ...
 * @author TDC, Inc.
 */
public final class CoinValidator extends AbstractComponent<CoinValidatorObserver>
	...
	/**
	 * Represents the output sink of this component when a coin is rejected.
	 */
	public Sink<Coin> rejectionSink;
	/**
	 * Represents the output sink of this component when a valid coin cannot be
	 * stored its standard sink.
	 */
	 ...
	 */
	public final Map<BigDecimal, Sink<Coin>> standardSinks;
	 ...
	 * not require power. Note that this is a method for use by infrastructural
	 * setup; it will not be used otherwise.
	 * 
	 * @param rejectionSink
	 ...
	 */
	public void setup(Sink<Coin> rejectionSink, Map<BigDecimal, Sink<Coin>> standardSinks, Sink<Coin> overflowSink) {
